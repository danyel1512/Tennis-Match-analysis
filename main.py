...
def main():
    ...
    #Choose players
    player_detections = player_tracker.assign_and_filter_players(keypoint_detected,player_detections)
    print(f"{player_detections[0]}")
    ...
    output_video_frames = player_tracker.draw_bounding_box(video_frames,
                                                           player_detections)
    output_video_frames = ball_tracker.draw_bounding_box(output_video_frames,
                                                           ball_detections)
    ...
    output_video_frames = minimap.draw_points_on_minimap(output_video_frames,player_minimap_detections,(255,0,255))
